...
class PrivacyDeleteDataSubjects extends Activity
{
    protected $eventName = 'API.PrivacyManager.deleteDataSubjects.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ visits ]

        return [
            'count' => count($finalAPIParameters['parameters']['visits'])
        ];
    }
    ...
    {
        return Piwik::translate('ActivityLog_PrivacyDeleteDataSubjects', [$activityData['count']]);
    }
}
