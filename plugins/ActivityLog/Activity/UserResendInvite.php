...
class UserResendInvite extends Activity
{
    protected $eventName = 'UsersManager.inviteUser.resendInvite';
    ...
    {
        list($userLogin, $email) = $eventData;
    ...
    {
        return Piwik::translate('ActivityLog_UserResentInvite');
    }
}