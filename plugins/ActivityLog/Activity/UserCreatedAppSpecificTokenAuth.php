...
class UserCreatedAppSpecificTokenAuth extends Activity
{
    protected $eventName = 'API.UsersManager.createAppSpecificTokenAuth.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ userLogin, passwordConfirmation, description, expireDate, expireHours ]
    ...
    {
        return Piwik::translate('ActivityLog_UserCreatedAppSpecificTokenAuth', $activityData['description']);
    }
}