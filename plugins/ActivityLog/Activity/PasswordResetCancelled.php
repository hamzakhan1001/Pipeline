...
class PasswordResetCancelled extends Activity
{
    protected $eventName = 'Login.resetPassword.cancelled';
    ...
    {
        return Piwik::translate('ActivityLog_PasswordResetCancelled');
    }
}
