...
class UserInvited extends Activity
{
    protected $eventName = 'UsersManager.inviteUser.end';
    ...
    {
        return Piwik::translate('ActivityLog_UserInvited');
    }
}
