...
class UserInviteDeclined extends Activity
{
    protected $eventName = 'UsersManager.inviteUser.declined';
    ...
    {
        return Piwik::translate('ActivityLog_UserDeclinedInvite', $activityData['inviterLogin']);
    }
}