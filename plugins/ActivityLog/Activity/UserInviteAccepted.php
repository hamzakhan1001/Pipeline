...
class UserInviteAccepted extends Activity
{
    protected $eventName = 'UsersManager.inviteUser.accepted';
    ...
    {
        [$userLogin, $email, $inviterLogin] = $eventData;
    ...
    {
        return Piwik::translate('ActivityLog_UserAcceptedInvite', $activityData['inviterLogin']);
    }
}