...
class PasswordResetConfirmed extends Activity
{
    protected $eventName = 'Login.resetPassword.confirmed';
    ...
    {
        return Piwik::translate('ActivityLog_PasswordResetConfirmed');
    }
}
