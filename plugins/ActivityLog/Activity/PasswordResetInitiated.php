...
class PasswordResetInitiated extends Activity
{
    protected $eventName = 'Login.resetPassword.initiated';
    ...
    {
        return Piwik::translate('ActivityLog_PasswordResetInitiated');
    }
}
