...
class PrivacyExportDataSubjects extends Activity
{
    protected $eventName = 'API.PrivacyManager.exportDataSubjects.end';
    ...
    {
        return Piwik::translate('ActivityLog_PrivacyExportDataSubjects', [$activityData['count']]);
    }
}