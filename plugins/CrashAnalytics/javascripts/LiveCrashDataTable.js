...
(function ($, require) {
  ...
  /**
   * UI control that handles extra functionality for Crash live datatables.
   *
   * @constructor
   */
  exports.LiveCrashDataTable = function (element) {
    this.parentAttributeParent = '';
    this.parentId = '';

    DataTable.call(this, element);

    // override date/period so segmented visitor log will always use current month
    this.param.period = 'month';
    this.param.date = 'today';
  };

  $.extend(exports.LiveCrashDataTable.prototype, dataTablePrototype, {
