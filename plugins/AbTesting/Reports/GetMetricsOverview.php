...
class GetMetricsOverview extends Base
{
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->filters[] = array(function (DataTable $table) use ($experiment, $idSite) {
            $recordBuilder = StaticContainer::getContainer()->make(Experiment::class, ['experiment' => $experiment]);
            $aggregateOperations = $recordBuilder->getMultipleReportsAggregationOperations();
            ...
            $summaryRow->deleteColumn(Metrics::METRIC_UNIQUE_VISITORS);
