...
class UsersFlowPageUrl extends GenericUsersFlow
{
    public function __construct()
    {
        ...
        parent::__construct(DataSources::DATA_SOURCE_PAGE_URL, $maxSteps, $configuration, Archiver::USERSFLOW_ARCHIVE_RECORD);
    }
}
