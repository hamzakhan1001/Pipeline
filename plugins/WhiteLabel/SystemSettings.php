...
class SystemSettings extends \Piwik\Settings\Plugin\SystemSettings
{
    ...
    private function enableWhatsNewSection()
    {
        return $this->makeSetting('enableWhatsNewSection', $default = true, FieldConfig::TYPE_BOOL, function (FieldConfig $field) {
            $field->title = Piwik::translate('WhiteLabel_SettingEnableWhatsNewSectionTitle');
            $field->description = Piwik::translate('WhiteLabel_SettingEnableWhatsNewSectionDescription');
            $field->inlineHelp = Piwik::translate('WhiteLabel_SettingEnableWhatsNewSectionInlineHelp', array('<br><strong>', '</strong>'));
            $field->uiControl = FieldConfig::UI_CONTROL_CHECKBOX;
        });
    }
