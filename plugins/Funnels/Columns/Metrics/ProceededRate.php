...
class ProceededRate extends ProcessedMetric
{
    ...
    {
        $proceeded = $this->getMetric($row, PluginMetrics::NUM_STEP_PROCEEDS);
    ...
    {
        return array(PluginMetrics::NUM_STEP_PROCEEDS, PluginMetrics::NUM_STEP_VISITS);
    }

    public function format($value, Formatter $formatter)
    {
        return NumberFormatter::getInstance()->formatPercent($value * 100, 1, 0);
    }
