...
/**
 * Update for version 5.0.0.
 */
class Updates_5_0_0 extends PiwikUpdates
{
    /**
    ...
    {
        $logFunnelTable = Common::prefixTable('log_funnel');
        return [
            $this->migration->db->sql("ALTER TABLE `{$logFunnelTable}` ADD `created_time` DATETIME NOT NULL")
        ];
    }
