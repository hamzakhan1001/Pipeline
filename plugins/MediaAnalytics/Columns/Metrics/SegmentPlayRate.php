...
class SegmentPlayRate extends ProcessedMetric
{
    ...
    {
        return Piwik::translate('MediaAnalytics_ColumnDescriptionSegmentPlayRate');
    }

    public function compute(Row $row)
    {
        $plays = $this->getMetric($row, PluginMetrics::METRIC_NB_PLAYS);
        $impressions = $this->getMetric($row, PluginMetrics::METRIC_SUM_PLAYS);
    ...
    {
        return array(PluginMetrics::METRIC_NB_PLAYS, PluginMetrics::METRIC_SUM_PLAYS);
    }
