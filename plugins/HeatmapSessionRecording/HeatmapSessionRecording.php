    ...
    public static function getTranslationKey($type)
    {
        ...
        switch ($type){
            case 'pause':
                ...
                break;
            case 'noDataSession':
                $key = 'HeatmapSessionRecording_NoSessionRecordedYet' . $appendWithoutSystemConfiguration;
                break;
            case 'noDataHeatmap':
                $key = 'HeatmapSessionRecording_NoHeatmapSamplesRecordedYet' . $appendWithoutSystemConfiguration;
                break;
        }
