...
class MatomoSearchTag extends BaseTag
{
    ...
    {
        return array(
            $this->makeSetting('search_keyword', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchKeywordTitle');
                $field->description = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchKeywordDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),

            $this->makeSetting('search_category', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchCategoryTitle');
                $field->description = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchCategoryDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),

            $this->makeSetting('search_total', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchTotalTitle');
                $field->description = Piwik::translate('TagManagerExtended_MatomoSearchTagSearchTotalDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),
        );
