...
class API extends \Piwik\Plugin\API
{
     ...
     * @param  string $conversionRuleOption The conversion rule selected
     ...
     * @return int
     */
    public function addForm($idSite, $name, $description = '', $matchFormRules = false, $matchPageRules = false, $conversionRuleOption = 'page_visit', $conversionRules = false)
    {
        ...
        return $this->formsModel->createForm($idSite, $name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules, $createdDate, $autoCreated);
    }
     ...
     *                              Example: array(array('attribute' => 'path', 'pattern' => 'equals', 'value' => '/sign-up-success'))
     */
    public function updateForm($idSite, $idForm, $name, $description = '', $matchFormRules = false, $matchPageRules = false, $conversionRuleOption = 'page_visit', $conversionRules = false)
    {
        $this->validator->checkWritePermission($idSite);
        $this->validator->checkSiteExists($idSite);// lets not configure any forms for not yet existing sites
        ...
        $this->formsModel->updateForm($idSite, $idForm, $name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules, $updatedDate);
    }
    ...
    public function getAutoCreationSettings($idSite)
    {
        ...
        $message = '';
        if ($value === SystemSettings::FORM_CREATION_UP_TO_3 || $value === SystemSettings::FORM_CREATION_UP_TO_10 || $value === SystemSettings::FORM_CREATION_UP_TO_50 || $value === SystemSettings::FORM_CREATION_UP_TO_150) {
            $limit = 3;
