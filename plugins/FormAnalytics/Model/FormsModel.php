...
class FormsModel
{
    ...
    public function createForm($idSite, $name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules, $createdDate, $autoCreated)
    {
        ...
        $idForm = $this->siteFormDao->createForm($idSite, $name, $description, $status, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules, $createdDate, $autoCreated);
    ...
    public function updateForm($idSite, $idForm, $name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules, $updatedDate)
    {
        $this->validateFormValues($name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules);
    ...
    private function validateFormValues($name, $description, $matchFormRules, $matchPageRules, $conversionRuleOption, $conversionRules)
    {
        $name = new Name($name);
        $name->check();
