...
class RuleMatcher
{
        ...
        foreach ($attributeValues as $attributeValue) {
            ...
            switch ($pattern) {
                ...
                case self::PATTERN_REGEXP:
                    if ($valueToMatch) {
                        $regex = self::completeRegExpValue($valueToMatch);
    ...
    public static function completeRegExpValue($pattern)
    {
    ...
    {
        return self::getAvailableConversionRuleList();
    }
    ...
    public static function getAvailableConversionRuleList()
    {
        return [
            self::KEY_CONVERSION_RULE_FORM_SUBMIT => Piwik::translate('FormAnalytics_FormSetupConversionRulesConditionFormSubmit'),
            self::KEY_CONVERSION_RULE_PAGE_VISIT => Piwik::translate('FormAnalytics_FormSetupConversionRulesConditionPageVisit'),
            self::KEY_CONVERSION_RULE_MANUALLY => Piwik::translate('FormAnalytics_FormSetupConversionRulesConditionJsOrTagManager'),
        ];
    }
